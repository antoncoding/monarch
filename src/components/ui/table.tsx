...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "bg-[var(--color-background-secondary)] text-xs text-gray-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cn(
      "bg-[var(--color-background-secondary)] border-l-2 border-[var(--color-background-secondary)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t bg-[var(--color-background-secondary)] font-medium",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-4 text-center align-middle [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
      className
    )}
    {...props}
  />
