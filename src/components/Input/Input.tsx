  ...
  return (
    <div className="relative flex-grow">
      ...
      <button
        type="button"
        onClick={handleMax}
        className="absolute right-2 top-1/2 -translate-y-1/2 transform rounded bg-surface p-1 text-sm text-secondary opacity-80 duration-300 ease-in-out hover:scale-105 hover:opacity-100"
      >
        Max
      </button>
    </div>
