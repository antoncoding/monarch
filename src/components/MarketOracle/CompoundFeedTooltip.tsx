    ...
    <div className="bg-surface flex max-w-xs rounded-sm border border-gray-200/20 p-4 shadow-sm dark:border-gray-600/15">
      <div className="flex w-full flex-col gap-3">
        ...
        <div className="rounded-sm border border-blue-200/30 bg-blue-50 p-3 dark:border-blue-600/20 dark:bg-blue-900/20">
          <div className="mb-1 font-zen text-sm font-medium text-blue-800 dark:text-blue-300">
            Compound Wrapper Feed
          </div>
          <div className="font-zen text-xs text-blue-700 dark:text-blue-400">
            This feed converts {underlyingChainlinkData?.baseAsset ?? 'Unknown'} /{' '}
            {underlyingChainlinkData?.quoteAsset ?? 'Unknown'} to {baseAsset} / {quoteAsset} using
            Compound's conversion logic.
          </div>
        </div>
        ...
        {underlyingChainlinkData && (
          <div className="space-y-2 border-t border-gray-200/30 pt-3 dark:border-gray-600/20">
            <div className="mb-2 flex items-center gap-2">
              {chainlinkLogo && (
                <Image src={chainlinkLogo} alt="Chainlink" width={12} height={12} />
              )}
