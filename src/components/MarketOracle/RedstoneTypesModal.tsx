        ...
        <div className="space-y-5">
          ...
          <div className="rounded-sm bg-hovered p-4">
            ...
            <p className="mt-2 text-sm text-secondary">
              Tracks market trading prices denominated in USD or major currencies (e.g., BTC/USD, ETH/BTC). Reflects real-time market
              movements with simple aggregation across exchanges.
            </p>
          </div>
          ...
          <div className="rounded-sm bg-hovered p-4">
            ...
            <p className="mt-2 text-sm text-secondary">
              Tracks the on-chain exchange rate between an underlying asset and its derivative from protocol smart contracts, offering less
              volatile pricing but introducing additional trust assumptions about the protocol&apos;s structure and reserve liquidity.
            </p>
            <p className="mt-2 text-xs text-secondary">Examples: wstETH/stETH from Lido, weETH/eETH from Ether.fi</p>
