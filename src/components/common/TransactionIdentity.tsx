...
export function TransactionIdentity({
  ...
  return (
    <Link
      ...
      className={`inline-flex items-center gap-1 rounded-sm bg-hovered px-2 py-1 font-monospace text-xs text-secondary no-underline transition-colors hover:bg-gray-300 hover:text-primary hover:no-underline dark:hover:bg-gray-700 ${className}`}
