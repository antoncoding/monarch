...
const supportedTokens = [
  ...
  },
  {
    ...
    decimals: 18,
    networks: [{ chain: mainnet, address: '0xdC035D45d973E3EC169d2276DDab16f1e407384F' }],
    peg: TokenPeg.USD,
  },
  {
    symbol: 'wUSDM',
  ...
  {
    symbol: 'cbDOGE',
    img: require('../imgs/tokens/cbdoge.svg') as string,
    decimals: 8,
    networks: [
  ...
  {
    symbol: 'cbLTC',
    img: require('../imgs/tokens/cbLTC.svg') as string,
    decimals: 8,
    networks: [
  ...
  {
    symbol: 'cbXRP',
    img: require('../imgs/tokens/cbxrp.svg') as string,
    decimals: 6,
    networks: [
  ...
  {
    symbol: 'cbADA',
    img: require('../imgs/tokens/cbada.svg') as string,
    decimals: 6,
    networks: [
