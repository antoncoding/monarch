...
const supportedTokens: ERC20Token[] = [USDC, USDT, USDA, PYUSD, crvUSD, frax, EURe, USDe, sUSDe, WETH, sDAI, wstETH, DAI, gtWETH, XPC, osETH, WBTC, rsETH, MKR, weETH, apxETH, LDO, rETH, ezETH, stEUR];
