...
- Lifetime position earnings must use the complete paginated supply/withdraw history with a zero opening balance before the first supply; do not request protocol contract state at chain block 0.
