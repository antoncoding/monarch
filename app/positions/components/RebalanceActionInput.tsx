...
export function RebalanceActionInput({
  ...
  return (
    <div className="mb-4 flex items-center justify-between rounded border-2 border-dashed border-orange-300 p-4 light:bg-orange-100 light:bg-opacity-20 dark:border-orange-700">
