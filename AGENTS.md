...
5. Prevent ad hoc feature-local implementations of shared concerns. ABI definitions, RPC/indexer/query hooks, domain matching, unit conversion, formatting, and large UI sections should live in established feature or shared chokepoints, not inside page components or one-off views.
